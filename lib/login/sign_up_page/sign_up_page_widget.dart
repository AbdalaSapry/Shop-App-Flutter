...
class _SignUpPageWidgetState extends State<SignUpPageWidget>
  ...
  void initState() {
    ...
    _model.textController2 ??= TextEditingController(text: 'abc@gmail.com');
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??= TextEditingController(text: '123456');
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              FFAppState().emailaddress =
                                  _model.textController2.text;
                              FFAppState().phonenumber = FFAppState().phone;
                              safeSetState(() {});
